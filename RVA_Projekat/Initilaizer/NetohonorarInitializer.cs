...
namespace RVA_Projekat.Initilaizer
{
    public class NetohonorarInitializer : INetohonorarInitializer
    {
        ...
        public void InitializeNetohonorars()
        {
            ...
            NetoHonorar nh = new NetoHonorar{ umanjenje = Enums.Umanjenje.DESET, uvecanje = Enums.Uvecanje.DVADEST };
            NetoHonorar nh2 = new NetoHonorar{  umanjenje = Enums.Umanjenje.PET, uvecanje = Enums.Uvecanje.DVADEST };
